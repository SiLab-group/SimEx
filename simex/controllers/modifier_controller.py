...
class ModifierController:
    ...
    def control(self, intervals_list, selected_modifier, do_plot):
        ...
        self.settings.mgs_mod_iterations += 1
        ...
        self.settings.mgs_points_generation_intervals += len(all_intervals_mod)
        self.settings.mgs_points_generated_total += current_iteration_points_number
