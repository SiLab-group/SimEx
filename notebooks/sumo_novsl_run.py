...
save_object(logger.all_fit_intervals_data,f"logger-novsl_script-fitted_intervals-{filename1}.pkl")
# If not empty
if logger.remaining_unfit_intervals:
    save_object(logger.remaining_unfit_intervals,f"logger-novsl_script-unfitted_intervals-{filename1}.pkl")
